...
public interface MemStrategy {
     ...
     */
    void initMemory(List<MemPartition> memory, String strSO, int size, Color color, int memory_size);
     ...
     */
    boolean hasExternalFragmentation();
     ...
     */
    String getProcessComponentInfo(ProcessMemUnit component);
     ...
     * @return size info
     */
    String getComponentSizeInfo(ProcessComplete p);
     ...
     */
    Vector<Vector<Object>> getProcessComponentsData(ProcessMemUnit process);
     ...
     */
    Vector<Object> getTableBlockInfo(MemPartition m);
     ...
     */
    Vector<Object> getFormTableHeader();
     ...
     */
    Vector<Vector<Object>> getFormTableInitData();
     ...
     */
    Vector<Object> getMemProcessTableHeader();
     ...
     */
    Vector<Vector<Object>> getMemProcessTableData(List<MemPartition> memory, ProcessComplete p);
     ...
     */
    void removeProcessInMemory(List<MemPartition> memory, MemPartition b);
     ...
     */
    void validateMemory(List<MemPartition> memory, int memory_size) throws SoSimException;
     ...
     * @param memory_size memory size
     */
    void compaction(List<MemPartition> memory, int memory_size);
     ...
     */
    void allocateProcess(List<MemPartition> memory, List<ProcessMemUnit> swap, ProcessMemUnit allocate, int memory_size) throws SoSimException;
     ...
     * @throws SoSimException process can not be allocated
     */
    void swapInProcessComponent(List<MemPartition> memory, List<ProcessMemUnit> swap, ProcessMemUnit swapped, int memory_size) throws SoSimException;
     ...
     */
    void swapOutProcess(List<MemPartition> memory, List<ProcessMemUnit> swap, MemPartition partition) throws SoSimException;
     ...
     */
    void removeSwappedProcessComponents(List<MemPartition> memory, List<ProcessMemUnit> swap, ProcessMemUnit swapped);
     ...
     */
    String getAddTransPhysical(MemPartition b, int logicalAddr, List<MemPartition> memory);
     ...
     */
    Vector<Vector<Vector<String>>> getXMLDataMemory(List<MemPartition> memory);
}
