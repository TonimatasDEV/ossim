...
public class FormBlock extends FormTemplate {
    ...
    public void init(Vector<Object> values) {
        ...
        if (values.size() > 1)
            spmodela = new SpinnerNumberModel(Integer.parseInt(values.get(1).toString()), 0, Integer.parseInt(values.get(0).toString()), 1);
        else spmodela = new SpinnerNumberModel(0, 0, Integer.parseInt(values.get(0).toString()), 1);
        ...
        if (values.size() > 1)
            spmodeli = new SpinnerNumberModel(Integer.parseInt(values.get(2).toString()), 1, Integer.parseInt(values.get(0).toString()), 1);
        else spmodeli = new SpinnerNumberModel(1, 1, Integer.parseInt(values.get(0).toString()), 1);
