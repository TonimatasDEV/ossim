...
public abstract class LogicalFSObject {
    ...
    private final PhysicalFSObject fsObject; // physical FS object, initial block (Fat entry) or inode
    private String name;
    private final FolderItem parent;
    private final List<String> path; // List contains path objects in proper order
