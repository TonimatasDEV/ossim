...
public class Functions {
    ...
    public String getResource(String key) {
        ...
        if (resource != null)
            return resource.replaceFirst("<lang>", AppSession.getInstance().getIdioma().getLanguage());
        return null;
    }
    ...
    public int getPropertyInteger(String key) {
        Integer property;
        try {
            property = Integer.valueOf(AppSession.getInstance().getProperties().getProperty(key));
