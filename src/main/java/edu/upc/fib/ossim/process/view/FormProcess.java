...
public class FormProcess extends FormTemplate {
    ...
    public void init(Vector<Object> values) {
        ...
        if (values.size() > 2)
            spmodelPrio = new SpinnerNumberModel(Integer.parseInt(values.get(3).toString()), 1, 10, 1);
        ...
        if (values.size() > 2)
            spmodelInit = new SpinnerNumberModel(Integer.parseInt(values.get(4).toString()), Integer.parseInt(values.get(0).toString()), 100, 1);
        else
            spmodelInit = new SpinnerNumberModel(Integer.parseInt(values.get(0).toString()), Integer.parseInt(values.get(0).toString()), 100, 1);
        ...
        for (int i = 0; i < burstsCycle.size(); i++) {
            ...
            row.add(new ColorCell(Integer.toString(i), Color.WHITE));
